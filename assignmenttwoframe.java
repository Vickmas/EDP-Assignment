...
public class assignmenttwoframe extends javax.swing.JFrame {
    String gender;
...
try{
    Class.forName("com.mysql.jdbc.Driver");
            try (Connection connect = DriverManager.getConnection("jdbc:mysql://localhost:3306/formregistration", "root","")) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(assignmenttwoframe.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new assignmenttwoframe().setVisible(true);
        });
    }
